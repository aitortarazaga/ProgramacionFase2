...
public class Centro extends javax.swing.JFrame {
    ...
    public Centro() {
        ...
        for(int x = 0; x < EjercicioFase2.llenarCb().size(); x++){
            CBid.insertItemAt(EjercicioFase2.llenarCb().get(x), x);
        }
    }
    ...
    private void BborrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BborrarActionPerformed
        ...
        char borrar;
        do{
           borrar=JOptionPane.showInputDialog(this,"¿Estas segur@ de querer borrar este centro? <s/n>").toLowerCase().charAt(0);
        }
        while(borrar!='s' && borrar!='n');
        
        switch (borrar){
            case 's':
                EjercicioFase2.borrarCentro(CBid.getSelectedItem());
                CBid.setSelectedItem(-1);
                TFnombre.setText("");
                JOptionPane.showMessageDialog(this,"Centro borrado satisfactoriamente");
            break;
            case 'n':
